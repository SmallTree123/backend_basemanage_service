package com.nylg.base.common.aspect;
...
public class SysLogAspect {
	...
	@Pointcut("@annotation(com.nylg.base.common.annotation.SysLog)")
	...
	private void saveSysLog(ProceedingJoinPoint joinPoint, long time) {
		...
		com.nylg.base.common.annotation.SysLog syslog = method.getAnnotation(com.nylg.base.common.annotation.SysLog.class);
		if(syslog != null){
			//注解上的描述
